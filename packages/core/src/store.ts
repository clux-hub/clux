...
export function setProcessedError(error: any, cluxProcessed: boolean): {__cluxProcessed__: boolean; [key: string]: any} {
  if (typeof error !== 'object') {
    error = {message: error};
  }
  Object.defineProperty(error, '__cluxProcessed__', {value: cluxProcessed, enumerable: false, writable: true});
  return error;
}
