...
export declare function renderApp<ST extends BStore = BStore>(baseStore: ST, preloadModules: string[], preloadComponents: string[], moduleGetter: ModuleGetter, middlewares?: IStoreMiddleware[], appModuleName?: string, appViewName?: string): {
    store: IStore<any> & ST;
